...
(0,0,0) circle (0.3) node {$H_1$};%1

\draw [rounded corners=4pt,color=white,ball color=blue,smooth]
(-0.433,-0.25,0.866) circle (0.3) node {$H_2$};%2

\draw [rounded corners=4pt,color=white,ball color=blue,smooth]
(-0.6495,0.625,0.433) circle (0.3) node {$H_3$};%3

\draw [rounded corners=4pt,color=white,ball color=red,smooth]
(-0.5174,0.0346,0.331) circle (0.4) node {C};%C

\draw [rounded corners=4pt,color=white,ball color=blue,smooth]
(-0.9873,-0.2367,0.0248) circle (0.3) node {$H_4$};%4
