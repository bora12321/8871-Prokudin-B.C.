...
\draw[red,->,>=stealth'] (0,0) -- ({\D*cos(\f)},{\D*sin(\f)}) node[right] {$\f$} -- ++ ({(\D/5)*cos((\f-180)+3*(\f))},{(\D/5)*sin((\f-180)+3*(\f))}); 
\draw[thin,<->] (2,0) arc(0:10:2) node[midway,right] {$\omega$};
\draw[thin,<->] ({(\D-1)*cos(10)},{(\D-1)*sin(10)}) arc(0:30:-1) node[midway,left] {$3\omega$};
\end{tikzpicture}
\end{document}
